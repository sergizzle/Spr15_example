...
- (void)viewDidLoad {
    ...
    self.nameList = @[@"Christophe",@"John",@"Michael Welker",@"Ted", @"Seth Heywood", @"John Radcliffe", @"Andrew Higgins", @"Miguel Lopez", @"Marcelo Sedano", @"Josh Ransom", @"Travis McMahon", @"Kristopher Smith"];
}
